...
def main():
    ...
    parser.add_argument('image_size', type = float, help = "Horizontal size of the image", default = 10)
    parser.add_argument('mass', type = float, help = "The mass of the lensing object", default = 0.5)
    parser.add_argument('camera_to_mass', type = float, help = "Distance from the observer to the mass", default = 3)
    parser.add_argument('mass_to_object', type = float, help = "Distance from the mass to the image", default = 3)
    parser.add_argument('mass_radius', type = float, help = "The radius of the lensing mass", default = 0.25)
